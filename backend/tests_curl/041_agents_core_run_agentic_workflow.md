# Endpoint Test: Agents Core - Run Agentic Workflow

## Endpoint Information
- **URL**: `POST /agents/agentic-workflows/run`
- **Method**: POST
- **Module**: Agents Core
- **Description**: Run agentic workflow
...
### cURL Command
```bash
curl -s -X POST http://localhost:8000/api/v1/agents/agentic-workflows/run \
